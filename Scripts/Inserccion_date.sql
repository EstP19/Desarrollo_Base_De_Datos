...
VALUES
('CC'),('PP'),('CE');
INSERT INTO employees (`name`, createdAt, updatedAt, lastname, birthday, email, phone, address, occupation, date_recruitment, document, idtype_document)
VALUES
...
INSERT INTO customers (`name`, lastname, email, phone, birthday, document, idtype_document)
VALUES
